...
import com.fiap.tech_challenge.parte1.ms_users.application.port.input.usertype.controller.CreateUserTypeUseCase;
...
public class CreateUserTypeUseCaseImpl implements CreateUserTypeUseCase {
    ...
    public CreateUserTypeUseCaseImpl(final UserTypeGateway userTypeGateway, IUserTypeMapper iUserTypeMapper) {
